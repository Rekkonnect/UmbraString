    ...
    : IUmbraString<BigEndianUmbraStringV2>
{
    ...
    public BigEndianUmbraStringV2 Concat(BigEndianUmbraStringV2 other, Span<byte> newBuffer)
    {
        ...
        Span<byte> resultSpan = stackalloc byte[sizeof(BigEndianUmbraStringV2)];
        ...
        ref var result = ref MemoryMarshal.AsRef<BigEndianUmbraStringV2>(resultSpan);
        return result;
    }

    public BigEndianUmbraStringV2 Slice(int start, int length)
    {
        if (length == 0)
            return default;
    ...
    private BigEndianUmbraStringV2 SliceShort(int start, int length)
    {
        Span<byte> resultSpan = stackalloc byte[sizeof(BigEndianUmbraStringV2)];
    ...
    private BigEndianUmbraStringV2 SliceLong(int start, int length)
    {
    ...
    {
        return UmbraStringHelpers.FitsShort<BigEndianUmbraStringV2>(span);
    }

    public static BigEndianUmbraStringV2 ConstructLong(SpanString span, Span<byte> outBuffer)
    {
        return UmbraStringHelpers.ConstructLong<BigEndianUmbraStringV2>(span, outBuffer);
    }
}
